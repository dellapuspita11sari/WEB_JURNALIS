          ...
          <div class="col-8">
              <div class="card card-outline card-primary">
                <div class="card-body">
					...
					<form action="../pages/pimred_upgrade.php" method="post" enctype="multipart/form-data">    
					<?php 
							$idanggota = $_GET['idanggota'];              
							$data = mysqli_query($koneksi, "SELECT* FROM pimpinan_redaksi WHERE idanggota='$idanggota'");
												...
												<div class="body" style="text-align:left">
													...
													<label>Foto</label><br>
														<div class="custom-file">
															<img src="../dist/img/anggota/pimred/<?php echo $d['gambar_anggota']; ?>" style="width: 120px;float: left; padding-top: 50px;">
