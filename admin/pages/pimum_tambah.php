...
if($filename == ""){
	mysqli_query($koneksi, "INSERT INTO pimpinan_umum VALUES (NULL,'$nama_anggota','$divisi','$ig')");
	...
	if(!in_array($ext,$allowed) ) {
		...
		mysqli_query($koneksi, "INSERT INTO pimpinan_umum VALUES (NULL, '$nama_anggota','$divisi','$ig','$file_gambar')");
		header("location:pimum.php");
	}
}
