          ...
          <div class="col-8">
              <div class="card card-outline card-primary">
                <div class="card-body">
					...
					<form action="../pages/anggota_upgrade.php" method="post" enctype="multipart/form-data">    
					<?php 
												...
												<div class="body" style="text-align:left">
													...
													<label>Foto</label><br>
														<div class="custom-file">
															<img src="../dist/img/anggota/<?php echo $d['gambar_anggota']; ?>" style="width: 120px;float: left; padding-top: 50px;">
